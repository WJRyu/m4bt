...
"
  ...
  "BM_M": {
    "title": "당신의 '일' 유형은...",
    "name": "'일'에서 '반응형'인 당신은...",
    "explain": "주어진 패턴대로 일하는 것을 선호해요. <br>일에 대한 큰 책임보다는 자신이 할 수 있는 만큼의 업무량을 하기를 원합니다. 일을 나서서 하기보다는 최대한 내게 주어진 만큼의 일을 제대로 수행하는 걸 선호합니다.
