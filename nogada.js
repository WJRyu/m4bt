...
var q_list = {
  ...
  97: {
    ...
    "type": "work",
    "subtype": "BM",
    "title": "나는 새로운 일을 시작할 때 주로 상대방의 의견이나 제안을 듣는 편이다.",
    "rev": "0"
  },
  98: {
    "num": "98",
  ...
  100: {
    ...
    "type": "work",
    "subtype": "BM",
    "title": "나는 누구와 대화를 하더라도 주로 경청하며 대화를 듣는 편이다.",
    "rev": "0"
  },
  101: {
    "num": "101",
  ...
  105: {
    ...
    "type": "baby",
    "subtype": "SI",
    "title": "나는 자녀의 교육 수준이 평균에 미치지 못하더라도 조급해하지 않는다.",
    "rev": "1"
  },
  106: {
    "num": "106",
...
var A_list = {
  "BM_B": {
    "title": "당신의 '일' 유형은...",
    "name": "'일'에서 '주도형' 인 당신은...",
    "explain": "책임감이 강한 성향으로 자신의 의견을 어필하고 설득하는 것을 잘하고 또 좋아합니다. 다른 사람의 강점을 발견하고 잠재력을 이끌어낼 수 있는 능력이 있어요. 적절하게 상대가 해야 할 일에 대해 알려주고 그들이 일을 잘 해낼 수 있도록 잘 리드합니다. 지시를 받아서 일하기보다는 주도적으로 스스로 일할 때 더 편안합니다. 자발적으로 일 할 때 에너지가 넘치고 살아있다는 기분을 느끼기도 해요. 성취 지향적으로 승진을 위해서 적극적이고 진취적으로 활동합니다. 주어진 프로젝트가 성공하기 위해서는 갈등을 피하지 않고 적극적으로 밀어붙입니다.<br>다른 사람의 이야기에 쉽게 흔들리지 않습니다. 결정을 내릴 때는 여러 정보를 종합하여 결정을 내리며 이미 내려진 결정에 후회하지 않고 좋은 결과가 나올 수 있도록 활동합니다. 책임감이 강해서 주어진 업무는 깔끔하게 처리하려고 해요. 어떤 상황에서든 누가 나서야 한다고 생각되면 기꺼이 먼저 나서서 도움을 주고 일을 해결합니다.<br>하지만 일을 주도하고 사람들을 이끄는 경향이 지나칠 경우엔 다소 직설적으로 표현으로 갈등이 생기는 경우가 많아요. 또 독선적으로 보일 수도 있지요. 나의 의견을 꾸준히 밀고 나가는 건 좋지만 과하면 고집을 부리는 모습이 될 수 있습니다. 나와 다른 의견이 나오면 반대한다고 느끼고 기분이 상하는 경우도 생기게 됩니다."
  },
  "BM_M": {
    "title": "당신의 '일' 유형은...",
    "name": "'일'에서 '반응형'인 당신은...",
    "explain": "주어진 패턴대로 일하는 것을 선호해요. 일에 대한 큰 책임보다는 자신이 할 수 있는 만큼의 업무량을 하기를 원합니다. 일을 나서서 하기보다는 최대한 내게 주어진 만큼의 일을 제대로 수행하는 걸 선호합니다. <br> 안정적인 환경을 추구하여 개인사업보다는 직원으로 일하는 것이 더 편하며, 높은 직급보다는 평사원으로 있길 원합니다. 워라밸이 중요해 임원이 돼 많은 업무에 시달리는 것보다는 적당히 일하고 나의 시간을 갖는 것을 더 선호하기 때문입니다. 직장 내 치열한 경쟁을 좋아하지 않습니다. 주변 사람들이 일을 잘 할 수 있도록 주변에서 돌아가는 상황을 잘 캐치하고 센스 있게 도움을 줍니다. 나를 굳이 드러내지 않고 다른 사람이 빛날 수 있도록 조력할 때 활기를 느끼며 중재자로서 역할도 잘 맡습니다. <br> 나의 의견을 주장하기보다는 주로 듣는 편이며, 의견이 다르더라도 조직 내 분위기를 흐리게 하지 않으려 넘어가는 편입니다. 모든 사람이 예라고 외치면 대세에 따라 함께 예라고 외치는 경향이죠. 흐름에 역행하지 않고 맞춰갑니다. 이런 모습으로 인해 주변에서 ‘너무 수동적이다.’ 는 평가를 받기도 합니다."
  },
  "SA_S": {
    "name": "안정추구형",
  ...
  "CM_C": {
    ...
    "explain": "자녀를 정말 많이 사랑하고 아끼는 분이에요. 아이가 잘 자랄 수 있도록 모든 일을 다 할 수 있다는 마음가짐을 갖고 계시죠. 최선을 다해서 아이에게 가장 최고의 것을 해주고 싶은 마음이 강한 분이에요. 아이를 잘 양육하면서 나의 성취감을 느끼는 경향이 있습니다. 그래서 아이를 위해서 나를 희생하는 데 거리낌이 없죠. 아이의 감정과 요구에 민감하게 반응하여 아이가 필요로 하는 걸 바로 알아차리고 제공해주는 성향이에요. 아이의 행동을 주의 깊게 관찰하고 자녀와 대화하며 자녀의 생각을 존중해줍니다. 그래서 아이와 관련된 일을 결정할 때 아이와 상의하여 결정하는 경우가 많아요.<br>아이를 잘 양육하며 성취감을 느끼기 때문에 자녀의 성과를 나의 성과라고 느끼기도 해요. 그래서 아이가 혼나거나 잘하지 못 하면 엄마인 내가 혼나고 못 하는 느낌이 들어 힘들어하기도 해요.<br>하지만 자녀를 우선하는 경우가 지나칠 경우에는 아이가 힘들지 않기 위해 모든 걸 다 대신해 주려 하거나 아이가 원하는 걸 들어준다는 이유로 아이가 마음대로 행동하도록 두기도 해요. 지나친 과잉보호로 오히려 자녀의 독립성이 발달 되지 못하는 경우도 있어요. 자녀의 성과를 나의 성과로 여기는 부분이 과해지면 교육에 지나치게 투자를 많이 하거나, 자녀에게 많은 기대를 하게 됨으로써 오히려 자녀와의 사이가 나빠질 수도 있어요. 또한, 육아, 양육에 나의 모든 육체적, 심리적 에너지를 쏟아 정작 나의 욕구에는 무심해져 나도 모르는 불만족감을 느낄 수 있답니다. 자녀가 성장하며 점점 스스로 하는 활동이 많아지면 의도치 않게 자녀로부터 상처를 받기도 해요."
  },
  "CM_M": {
    "title": "당신의 '육아' 유형은...",
    "name": "'육아'에서 '균형형'인 당신은...",
    "explain": "자녀와 나를 각각 독립된 사람으로 생각해요. 아이도 중요하지만 내 삶도 중요하다! 란 생각을 갖고 있죠. 자녀가 독립적으로 활동할 수 있도록 지지합니다. 자율적인 분위기를 선호하고 아이를 믿어주고 아이가 스스로 시도해 볼 수 있는 기회를 제공해요. 나의 일에 집중하기 위해서라도 자녀가 독립적으로 활동할 수 있게 교육하는 경향이에요. 자녀의 유능감이 발달할 수 있도록 잘 지지하는 성향의 엄마예요. 내가 행복해야 자녀가 행복하다고 생각하는 성향입니다. 자녀와 논리적인 대화를 해 자녀의 지적인 발달 호기심, 과제 집착력, 도전 정신을 발달시키는 데 도움을 줍니다. 자녀들에게 주체적인 삶을 사는 여성의 모습으로 롤모델이 돼 주기도 합니다. <br>자녀를 열심히 돌보고 양육하면서 꾸준히 내가 성장하길 바라서 자기계발에 많은 관심을 가져요. 진취적이고 성취 지향적인 성향으로 일과 육아 모두 잘 성취하고 싶은 마음도 커요.<br>하지만 나를 생각하는 게 지나치게 될 경우에는 육아에 소홀하게 되는 경우가 있기도 해요. 은연중에 나의 일정에 아이가 무조건 맞춰야 한다고 강요할 수 있습니다. 내가 세운 계획, 일정대로 자녀가 맞추길 바라는 경우가 생기기도 해요. 스스로 일방적으로 헌신하고 희생한다고 생각할 경우 많은 스트레스를 받게 돼요. 이성적으로 생각하는 경우가 많다 보니 자녀의 감정적인 표현에 나도 모르게 무심하게 반응하기도 해요. 자녀가 의존적인 모습을 보일 때 아이가 독립적이지 못 한 모습을 보며 과하게 걱정이 되기도 합니다."
  },
  "EE_E1": {
    "name": "육아효능감",
  ...
  "EI_E": {
    "title": "당신의 '자아' 유형은...",
    "name": "'자아'에서 '외향형'이며 ",
    "explain": "내 생각과 감정을 겉으로 표현해야 편한 성향으로 세상과 직접적으로 소통할 때 에너지를 많이 얻습니다. 내 주변 사물이나 사람들에게 관심이 많아요. 직접 행동으로 옮기거나 말로 표현을 하면서 생각이 정리돼요. 그래서 주변에서 봤을 때 잘 나서고 주도적인 사람으로 보이기도 합니다. 좋으면 좋다고 티가 나고 싫으면 싫다고 티가 잘 나기도 합니다. 실내에 너무 오래 갇혀 있으면 답답함을 느껴요. 사람들과 함께할 때 정말 즐겁고 충전됨을 느낍니다.<br> 새로운 사람을 만나도 먼저 인사하고 어색함을 깨는 경향이 있어요. 사교성이 좋고, 나라는 사람을 언어로 드러내는 것을 선호해 말로 표현하는 능력도 우수한 편이에요. 행동력, 추진력이 높은 편입니다. 나의 외부에서 일어나는 활동에는 관심이 많고 즉각적으로 알아차리지만, 마음속에서 일어나는 부분은 빨리 알아차리지 못 할 수 있어요. <br> 나의 의견을 외부로 표현하는 성향이다 보니 상대도 외부로 표현을 해줘야 편합니다. 나의 표현에 상대의 피드백이 적으면 불편해해요."
  },
  "EI_I": {
    "title": "당신의 '자아' 유형은...",
    "name": "'자아'에서 '내향형'이며 ",
    "explain": "혼자 있을 때 편안함을 느끼는 성향입니다. 내 생각과 감정을 내 마음속에서 조용히 소화하는 걸 더 좋아해요. 여러 사람과 만나는 것보다는 소수의 사람과 지내는 게 더 편해요. 겉으로 보기에는 감정 기복이 심하지 않은 것처럼 보입니다. 굳이 내 생각과 감정을 겉으로 드러내려 하지 않기 때문이죠. 나를 표현할 때는 말보다 글로 표현하는 걸 더 선호하기도 합니다. 집순이들이 많을 수 있습니다. 외부활동보다는 실내활동을 더 좋아하기 때문이죠. 외부활동을 할 때도 혼자 조용히 할 때 만족감을 느낍니다. 여러 사람들과 만나는 자리에서도 잘 지내기는 하나 집에 돌아오면 에너지가 소진된다면 내향형일 가능성이 높습니다. <br> 내 마음속에서 일어나는 상태를 알아차리고 이게 나에게 어떤 의미가 있는지 가치를 파악하는 능력이 좋은 편이에요. 주된 관심은 개념, 생각, 내적 경험의 세계에 있어요. 행동하거나 말로 표현하기 전에 한 번 더 생각하고 신중하게 움직여요. <br> 굳이 나를 표현하지 않아도 되는 상황에서 먼저 나를 드러내지는 않지만, 나를 드러내야 하는 상황에서는 또 열정적으로 자신을 표현하기도 합니다. 내 마음속에서 일어나는 상황에 관심이 많다 보니 외부환경에서 일어나는 일에는 무덤덤하게 반응할 수 있어요."
  },
  "SS_S1": {
    "name": "자존감",
  ...
  "SG_S": {
    ...
    "explain": "타인에게 해를 주는 걸 별로 좋아하지 않아요. 그리고 자신도 타인에게 피해를 받는 걸 좋아하지 않아요. 자기 자신의 존재로 인정받길 원하며 자신의 자유와 개성을 누리기를 바라는 경향입니다. 마음속 깊은 곳에 나만의 선이 있어서 이 선을 넘는 걸 매우 싫어해요. 합리적이고 이성적으로 생각하는 걸 좋아해요. 어떤 상황에 대해서 객관적으로 생각하고 판단하는 경향이 있습니다. 이 판단하는 기준은 자신 내면에 있는 원칙이 기준이 됩니다. <br> 자신의 자율성, 독립성 그리고 자신의 결정을 중시하는 성향이에요. 내가 세운 목적, 목표, 욕구, 성취, 권리를 집단이 침해하면 매우 불편해해요. 자신 스스로 나의 기준대로 행동하고 독립적이고 자율적인 경향이 있습니다. 모두가 아니라고 할 때 예! 	라고 외칠 수 있는 용기가 있어요.<br> 단호하게 보이기도 하지만 합리적이고 효율적인 걸 추구하여 최대한 공정하게 행동하기 때문에 주변에서도 불만이 적습니다. <br> 하지만 이 성향이 지나칠 경우에는 계산적인 사람으로 보이거나 정 없는 사람처럼 보일 수 있습니다. 주변 사람들에게 관심이 적어 사람들의 감정적인 부분을 놓쳐 불필요한 오해를 받을 수 있습니다. 주고받는 게 확실해 누군가의 호의를 받을 때 ‘갚아야 한다’는 생각때문에 불편해 할 수 있어요."
  },
  "SG_G": {
    "title": "당신의 '관계' 유형은...",
    "name": "'관계'에서 '사회형'인 당신은...",
    "explain": "주변 사람들과 잘 협력하며 내가 속한 조직의 성공을 위해 열심히 활동하는 경향입니다. 공동체 의식을 가치 있게 생각하며 나의 조직이 잘 유지될 수 있도록 노력합니다. 공동체 안에서 조화를 중시하며 다른 조직 구성원의 요구에 관대해요. 서로서로 도움을 주고 주의 깊게 대하는 걸 선호하는 성향입니다. 누군가가 소외되는 모습을 보면 먼저 다가 소외된 사람들도 집단의 일부가 되도록 노력합니다. 모두가 조화롭게 지내는 걸 편안해해요. 내가 튀는 것보다는 조용히 나의 역할을 수행하는 성향입니다.<br>나의 개인적인 이익보다는 사람들 관계가 깨지지 않는 걸 더 중요하게 생각해요. 그래서 나의 결정으로 인해 혹시 주변 사람들이 상처받을까 봐 한 번 더 생각하고 결정합니다. 모두가 만족스러운 결과를 내길 바라는 경향이에요. 다른 사람들의 의견을 잘 수용하고 공감하며, 내가 불편한 부분이 있어도 잘 참습니다. 갈등이 생기는 걸 꺼려하기에 모두가 예라고 하면 나도 예라고 하는 경향입니다. 비판보다는 따듯한 격려를 먼저 하며 상대방이 잘 한 것을 잘 발견하고 칭찬해줍니다.<br>하지만 이런 성향이 지나칠 경우에는 내키지 않아도 조직 분위기를 해치지 않기 위해 자신의 의견을 계속 양보하다 보니 불만족이 쌓이게 돼요. 나의 정체성이 집단의 정체성에 의해 결정되기 때문에 집단이 해체될 경우 자존감이 많이 떨어지기도 합니다. 사람과 사이에서 갈등이 생길 경우 지나치게 스트레스를 받게 되는데요, 주변 사람을 너무 생각하느라 정작 나의 일에는 소홀해질 수 있습니다. 스트레스가 많아지면 갈등을 해결하기보다는 회피하게 되며 수동 공격적인 행동이 나타날 수 있습니다."
  },
  "CA_C": {
    "name": "타인이해",
...
function next() {
  if (num == 107) {
    ...
    ($("#SA").val() <= 9) ? res1 += "SA_A": res1 += "SA_S";
    $(".explain1").html(A_list[res1]["explain"]);
    ($("#AN").val() <= 9) ? res2 += "AN_N": res2 += "AN_A";
    $(".explain2").html(A_list[res2]["explain"]);
    ($("#CM").val() <= 11) ? res3 += "CM_M": res3 += "CM_C";
    ...
    ($("#EE").val() <= 7) ? res4 += "EE_E2": res4 += "EE_E1";
    $(".explain4").html(A_list[res4]["explain"]);
    ($("#SI").val() <= 7) ? res5 += "SI_I": res5 += "SI_S";
    $(".explain5").html(A_list[res5]["explain"]);
    ($("#IN").val() <= 3) ? res6 += "IN_N": res6 += "IN_I";
    $(".explain6").html(A_list[res6]["explain"]);
    ($("#EI").val() <= 13) ? res7 += "EI_I": res7 += "EI_E";
    ...
    ($("#SS").val() <= 9) ? res8 += "SS_S2": res8 += "SS_S1";
    $(".explain8").html(A_list[res8]["explain"]);
    ($("#RR").val() <= 3) ? res9 += "RR_R2": res9 += "RR_R1";
    $(".explain9").html(A_list[res9]["explain"]);
    ($("#RI").val() <= 5) ? res10 += "RI_I": res10 += "RI_R";
    $(".explain10").html(A_list[res10]["explain"]);
    ($("#SG").val() <= 11) ? res11 += "SG_G": res11 += "SG_S";
    ...
    ($("#CA").val() <= 7) ? res12 += "CA_A": res12 += "CA_C";
    ...
    $(".result1").attr('style', 'color:#6496ed;');
      ...
      $(".img").attr('src', './index2/img/ISBR.png";');
